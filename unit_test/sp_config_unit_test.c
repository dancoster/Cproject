...
bool configFileNoArgs(){
	SP_CONFIG_MSG msg;
	ASSERT_TRUE(spConfigCreate("./unit_test/configs/config_no_dir.config",&msg)==NULL);
	ASSERT_TRUE(msg==SP_CONFIG_INVALID_STRING);
	ASSERT_TRUE(spConfigCreate("./unit_test/configs/config_no_prefix.config",&msg)==NULL);
	ASSERT_TRUE(msg==SP_CONFIG_INVALID_STRING);
	ASSERT_TRUE(spConfigCreate("./unit_test/configs/config_no_suffix.config",&msg)==NULL);
	ASSERT_TRUE(msg==SP_CONFIG_INVALID_STRING);
	ASSERT_TRUE(spConfigCreate("./unit_test/configs/config_no_num_images.config",&msg)==NULL);
	ASSERT_TRUE(msg==SP_CONFIG_INVALID_STRING);
...
bool configFileMissingParameterLines(){
	SP_CONFIG_MSG msg;
	ASSERT_TRUE(spConfigCreate("./unit_test/configs/config_no_prefix_line.config",&msg)==NULL);
	ASSERT_TRUE(msg==SP_CONFIG_MISSING_PREFIX);
	ASSERT_TRUE(spConfigCreate("./unit_test/configs/config_no_suffix_line.config",&msg)==NULL);
	ASSERT_TRUE(msg==SP_CONFIG_MISSING_SUFFIX);
	ASSERT_TRUE(spConfigCreate("./unit_test/configs/config_no_dir_line.config",&msg)==NULL);
	ASSERT_TRUE(msg==SP_CONFIG_MISSING_DIR);
	ASSERT_TRUE(spConfigCreate("./unit_test/configs/config_no_num_images_line.config",&msg)==NULL);
...
bool configFileInvalidArgs(){
	SP_CONFIG_MSG msg;
	ASSERT_TRUE(spConfigCreate("./unit_test/configs/config_invalid_dir.config",&msg)==NULL);
	ASSERT_TRUE(msg==SP_CONFIG_MISSING_DIR);
	ASSERT_TRUE(spConfigCreate("./unit_test/configs/config_invalid_prefix.config",&msg)==NULL);
	ASSERT_TRUE(msg==SP_CONFIG_MISSING_PREFIX);
	ASSERT_TRUE(spConfigCreate("./unit_test/configs/config_invalid_suffix.config",&msg)==NULL);
	ASSERT_TRUE(msg==SP_CONFIG_MISSING_SUFFIX);
	ASSERT_TRUE(spConfigCreate("./unit_test/configs/config_invalid_num_images.config",&msg)==NULL);
	ASSERT_TRUE(msg==SP_CONFIG_MISSING_NUM_IMAGES);
//	ASSERT_TRUE(spConfigCreate("./unit_test/configs/config_invalid_num_features.config",&msg)==NULL);
//	ASSERT_TRUE(msg==SP_CONFIG_MISSING_NUM_IMAGES);
	return true;
}
...
bool configFilesSetValues(){
	...
	config = spConfigCreate("./unit_test/configs/config_valid.config",&msg);
...
bool configFilesDefultValues(){
	...
	config = spConfigCreate("./unit_test/configs/config_deafult.config",&msg);
	num = spConfigGetNumOfFeatures(config,&msg);
	ASSERT_TRUE(num==100);
	ASSERT_TRUE(msg==SP_CONFIG_SUCCESS);
